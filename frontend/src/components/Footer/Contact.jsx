...
const Contact = () => {
  ...
  <p className="text-sm text-justify font-normal font-poppins pb-6 min-w-[200px] mb-4">
    ...
    career support. We offer industry-relevant certification programs
    in Data Analytics, Digital Marketing with AI, Software Testing,
    Communication Skills, and more — combining expert-led live training,
    internships, and placement support. Our mission is to bridge the
    gap between education and employability, making career success
    accessible to all.
  </p>
    ...
    <p className="text-base ">support@baoiam.com</p>
        ...
        <div className="flex-1 w-full md:w-auto   md:px-0 mt-8 md:mt-0">
          <img
            src={MobileMockup}
            alt="Mobile App Mockup"
            className="w-full max-w-[400px] h-auto md:h-[650px] object-contain mx-auto"
          />
        </div>
      </div>
    </div>
