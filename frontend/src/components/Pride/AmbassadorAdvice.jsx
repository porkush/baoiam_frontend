    ...
    <section className="relative font-['Poppins'] overflow-hidden">
      ...
      <div className="bg-white text-center px-4 py-12 mb-16 sm:mb-28">
        <div className="flex items-center justify-center w-full mb-4">
          <h2 className="text-[26px] md:text-[48px] font-semibold mb-2">
          ...
          <img src={Group} alt="" className="hidden md:block w-9 mb-4" />
        </div>
        ...
        <div className="flex justify-center gap-2 sm:gap-4 flex-wrap">
          <Link to="/DataScience">
            <button className="bg-orange-500 hover:bg-orange-600 text-white px-2 sm:px-5 py-1 sm:py-2 rounded-md text-[14px] md:text-xl font-medium transition">
              Enroll Now
            </button>
          </Link>
          <div className="text-left">
            <button
              className="bg-black text-white border rounded-lg px-2 sm:px-5 py-1 sm:py-2  text-[14px] md:text-xl hover:bg-[#7B7B7B]"
          ...
          >
            <div className="relative w-full h-0 pb-[56.25%]">
              ...
              <iframe
                ...
                src={`https://www.youtube.com/embed/uJM97uM_SZE?autoplay=${
                  isPlaying ? 1 : 0
                }&mute=0&loop=1&playlist=uJM97uM_SZE`}
