      ...
      <div className="flex flex-col flex-1 min-w-[300px]">
        ...
        <div className="flex flex-row items-start gap-1 sm:gap-6 md:gap-8">
          <img
            src={rocket}
            alt="Rocket"
            className="w-[60px] h-[70px] sm:w-[100px] sm:h-[100px] md:w-[130px] md:h-[130px] lg:w-[160px] lg:h-[160px] object-contain"
          />

          <div className="text-left">
            <h1 className="text-[22px] sm:text-2xl md:text-[30px] lg:text-[40px] font-semibold text-[#FF6501] leading-tight">
              Data Science{" "}
              <span className="text-black font-medium">Career</span>
            </h1>
            <p className="text-[14px] sm:text-xl md:text-[22px] lg:text-[28px] font-medium mt-2">
              Starts at{" "}
              <span className="line-through text-base sm:text-lg font-medium">
                ₹79,999
              </span>{" "}
              <span className="text-[#FF6501] font-semibold text-[24px] sm:text-[28px] md:text-[36px] lg:text-[40px]">
                ₹4,999
              </span>
            </p>
          </div>
        ...
        {/* Features */}
        <div className="mt-4 md:mt-6 text-left text-[14px] sm:text-lg md:text-[22px] lg:text-[28px] font-medium">
          <p className="text-gray-700">
            <span className="text-orange-500">12 Months</span> |{" "}
            <span className="text-black">Live classes</span> |{" "}
            <span className="text-orange-500">Projects</span> |{" "}
        ...
        {/* Buttons */}
        <div className="mt-5 flex gap-4 text-[12px] sm:text-base md:text-lg lg:text-xl font-medium">
          <Link to="/DataScience">
            <button className="bg-black text-white px-5 py-1 sm:py-2 rounded-lg hover:bg-[#7B7B7B]">
              Enroll Now
            </button>
          </Link>
