...
//       <div className="relative h-[250px] max-w-3xl mx-auto px-4">
//   {testimonials.map((testimonial, index) => (
//     <div
//       key={testimonial.id}
//       className={`${getCardClasses(index)} overflow-hidden p-4`}
//     >
...
//         />
//         <div>
//           <p className="font-bold text-gray-800 text-lg md:text-xl">{testimonial.author}</p>
//           <p className="text-gray-600 font-medium text-sm md:text-base">{testimonial.role}</p>
//         </div>
//       </div>
//       <p className="text-gray-700 italic text-base md:text-lg mb-6 mt-2 overflow-auto break-words">
//         "{testimonial.content}"
//       </p>
//     </div>
//   ))}
