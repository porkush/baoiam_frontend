...
//   return (
//     <div className="lg:w-[1250px] border-b-2 border-gray-200 mx-auto flex flex-col items-center justify-center relative px-4 md:px-8 py-4 ">
...
//             style={{
//               transform:
//                 window.innerWidth >= 1024 ? getTransformValue() : "none",
