...
export default function CoursePage() {
  return (
    <div className="bg-white font-sans text-gray-800">
      ...
      <div className="max-w-7xl mx-auto p-4 md:flex md:space-x-8">
        {/* Left Side */}
        <div className="flex-1">
          <h1 className="text-3xl md:text-[40px] font-semibold mb-4">
            Master Data Analysis
          </h1>
          <p className="text-[#1B1B1BCC] text-[18px] mb-4">
            From Zero to Analytical Hero - In just 12 Months!
          </p>
          ...
          {/* Stats */}
          <div className="w-full my-10 max-w-[566px] min-h-[68px] rounded-[20px] bg-black text-white px-6 md:px-[20px] lg:px-[40px] py-2 md:py-[10px] flex flex-col md:flex-row justify-between items-center gap-3 md:gap-0 ">
            {/* Got Placed */}
            <div className="text-center">
            ...
            {/* Reviews with Star to the Right */}
            <div className="text-center">
              <p className="text-[18px] font-semibold flex items-center justify-center">
                4.8
            ...
            {/* Learners with Avatar on the Right */}
            <div className="text-center">
              <div className="flex items-center justify-center">
        ...
        {/* Right Side */}
        <aside className="mt-10 md:mt-0 md:w-2/5">
          <div className=" rounded-lg p-4 shadow-sm">
            <div className="bg-[#FF6501] text-white text-[18px] rounded-t-lg px-4 py-2">
              Rs 7 LPA median salary, 20,000 jobs available
            </div>

            <div className="relative mt-4 mb-4 rounded-xl overflow-hidden">
              <img
