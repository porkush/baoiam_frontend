...
const ContactUs = () => {
  ...
  <div className="w-full md:w-1/2 space-y-6">
    ...
    <p className="text-black max-w-lg">
      Have any query, feedback, or need assistance? We're just a message away. Fill out the form below, and our team will get back to you shortly.
    </p>
  ...
  <div className="w-full md:w-1/2 flex ">
    <div className="bg-white w-full max-w-xl p-6 rounded-[12px] shadow-md shadow-gray-400">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        {/* Full Name */}
        <div>
          <label htmlFor="fullName" className="block text-sm font-medium text-[#333] mb-1">
            Full name
          </label>
          <input
            type="text"
        ...
        {/* Mobile Number */}
        <div>
          <label htmlFor="mobileNumber" className="block text-sm font-medium text-[#333] mb-1">
            Contact Number
          </label>
          <input
            type="tel"
        ...
        <div>
          ...
          <div className="relative">
            <select
              ...
              required
              disabled={
                !subCategories[category1] || subCategories[category1].length === 0
              }
            >
